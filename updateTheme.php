<?php
    $themeConfig=[];
    $themeList = json_decode(file_get_contents("new_themes/themelist.json"), false);
    foreach($themeList as $themeCode => $themeFile) {
        $themeConfig[$themeCode]=json_decode(file_get_contents("new_themes/$themeFile.json"), false);
    }
